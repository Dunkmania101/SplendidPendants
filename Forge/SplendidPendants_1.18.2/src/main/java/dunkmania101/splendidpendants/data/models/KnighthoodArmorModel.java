...
public class KnighthoodArmorModel extends BaseDyeableModel {
    public KnighthoodArmorModel(ItemStack stack) {
        super(createArmorLayer(), stack, DyeColor.GRAY);
    }
    ...
    public static LayerDefinition createArmorLayer() {
        ...
        knighthoodArmorHead.texOffs(0, 0).addBox(-7.0F, -2.0F, -7.0F, 14.0F, 4.0F, 14.0F, false);
        knighthoodArmorHead.texOffs(0, 0).addBox(-7.0F, -14.0F, -7.0F, 14.0F, 4.0F, 14.0F, false);
        knighthoodArmorHead.texOffs(0, 0).addBox(-6.0F, -10.0F, -6.0F, 12.0F, 8.0F, 12.0F, false);
