...
public class AtlanticTailModel extends BipedModel<LivingEntity> {
    ...
    public AtlanticTailModel(ItemStack stack) {
        ...
        leftLegModel.setTextureOffset(0, 0).addBox(-7.0F, 1.0F, -3.0F, 10.0F, 2.0F, 6.0F, 0.0F, false);
        leftLegModel.setTextureOffset(0, 0).addBox(-6.0F, 3.0F, -2.0F, 8.0F, 9.0F, 4.0F, 0.0F, false);
        leftLegModel.setTextureOffset(0, 0).addBox(-4.0F, 12.0F, 0.0F, 4.0F, 2.0F, 0.0F, 0.0F, false);
        leftLegModel.setTextureOffset(0, 0).addBox(-5.0F, 15.0F, 0.0F, 6.0F, 1.0F, 0.0F, 0.0F, false);
        leftLegModel.setTextureOffset(0, 0).addBox(-6.0F, 14.0F, 0.0F, 8.0F, 1.0F, 0.0F, 0.0F, false);
        leftLegModel.setTextureOffset(0, 0).addBox(-6.0F, 16.0F, 0.0F, 3.0F, 1.0F, 0.0F, 0.0F, false);
        leftLegModel.setTextureOffset(0, 0).addBox(-1.0F, 16.0F, 0.0F, 3.0F, 1.0F, 0.0F, 0.0F, false);
        leftLegModel.setTextureOffset(0, 0).addBox(-5.0F, 17.0F, 0.0F, 2.0F, 1.0F, 0.0F, 0.0F, false);
        leftLegModel.setTextureOffset(0, 0).addBox(-1.0F, 17.0F, 0.0F, 2.0F, 1.0F, 0.0F, 0.0F, false);
        leftLegModel.setTextureOffset(0, 0).addBox(-4.0F, 18.0F, 0.0F, 1.0F, 1.0F, 0.0F, 0.0F, false);
        leftLegModel.setTextureOffset(0, 0).addBox(-1.0F, 18.0F, 0.0F, 1.0F, 1.0F, 0.0F, 0.0F, false);
        leftLegModel.setTextureOffset(0, 0).addBox(-3.0F, 4.0F, 2.0F, 2.0F, 1.0F, 1.0F, 0.0F, false);
        leftLegModel.setTextureOffset(0, 0).addBox(-3.0F, 6.0F, 2.0F, 2.0F, 1.0F, 1.0F, 0.0F, false);
        leftLegModel.setTextureOffset(0, 0).addBox(-3.0F, 8.0F, 2.0F, 2.0F, 1.0F, 1.0F, 0.0F, false);
        leftLegModel.setTextureOffset(0, 0).addBox(-3.0F, 4.0F, -3.0F, 2.0F, 1.0F, 1.0F, 0.0F, false);
