...
public class DyeSpongeItem extends Item {
    ...
    public void addDye(ItemStack stack, DyeColor color, Player player) {
        ...
        stack.setTag(nbt);
        player.displayClientMessage(Component.translatable("msg.splendidpendants.add_dye_success").withStyle(Style.EMPTY.withColor(TextColor.fromRgb(newColor))), true);
    }
    ...
    public void appendHoverText(@Nonnull ItemStack stack, @Nullable Level worldIn, @Nonnull List<Component> tooltip, @Nonnull TooltipFlag flagIn) {
        ...
        tooltip.add(Component.translatable("msg.splendidpendants.dye_sponge_sneak_use_instructions").withStyle(ChatFormatting.GRAY));
        int color = getColor(stack);
        tooltip.add(Component.translatable("msg.splendidpendants.sponge_color").withStyle(Style.EMPTY.withColor(TextColor.fromRgb(color))));
        tooltip.add(Component.literal("R: " + Tools.getRed(color)).withStyle(ChatFormatting.RED, ChatFormatting.BOLD));
        tooltip.add(Component.literal("G: " + Tools.getGreen(color)).withStyle(ChatFormatting.GREEN, ChatFormatting.BOLD));
        tooltip.add(Component.literal("B: " + Tools.getBlue(color)).withStyle(ChatFormatting.BLUE, ChatFormatting.BOLD));
    }
}
