...
public class PendantItem extends ArmorItem {
    ...
    public void appendHoverText(@Nonnull ItemStack stack, Level worldIn, @Nonnull List<Component> tooltip, @Nonnull TooltipFlag flagIn) {
        ...
        tooltip.add(Component.translatable("msg.splendidpendants.use_instructions").withStyle(ChatFormatting.GRAY));
        tooltip.add(Component.translatable("msg.splendidpendants.divider"));
        tooltip.add(Component.translatable("msg.splendidpendants.is_enabled").withStyle(ChatFormatting.GRAY));
        if (PendantTools.isEnabled(stack)) {
            tooltip.add(Component.translatable("msg.splendidpendants.enabled").withStyle(ChatFormatting.GREEN, ChatFormatting.BOLD));
        } else {
            tooltip.add(Component.translatable("msg.splendidpendants.disabled").withStyle(ChatFormatting.RED, ChatFormatting.BOLD));
        }
        tooltip.add(Component.translatable("msg.splendidpendants.divider"));
        String altInvKey = getAltInvKey();
        if (altInvKey != null) {
            tooltip.add(Component.translatable("msg.splendidpendants.when_enabled"));
            tooltip.add(Component.translatable(altInvKey)
                        .withStyle(ChatFormatting.GRAY));
            if (isDyeable()) {
                tooltip.add(Component.translatable("msg.splendidpendants.divider"));
                tooltip.add(Component.translatable("msg.splendidpendants.when_disabled"));
            }
        }
        if (isDyeable()) {
            tooltip.add(Component.translatable("msg.splendidpendants.dyeable_sneak_use_instructions").withStyle(ChatFormatting.GRAY));
            tooltip.add(Component.translatable("msg.splendidpendants.divider"));
        }
    }
